package com.matheus.projetointegradoriii.api.exceptionHandler;
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(UniqueResourceBeingUsed.class)
    public ResponseEntity<Object> handleUniqueResourceBeingUsed(UniqueResourceBeingUsed ex, WebRequest request) {

        HttpStatusCode statusCode = HttpStatusCode.valueOf(HttpStatus.BAD_REQUEST.value());
        ApiErrorType errorType = ApiErrorType.UNIQUE_RESOURCE_BEING_USED;
